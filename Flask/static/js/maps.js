(function ($, pageScript) {
    ...
    function mainMap() {
        ...
        var returnPageScript = pageScript();
        var locations = returnPageScript[0];
        var lat_center = returnPageScript[1];
        var lon_center = returnPageScript[2];
        var testlat = 40.7
        var testlon = -73.87
